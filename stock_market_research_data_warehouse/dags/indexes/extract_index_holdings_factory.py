...
class ExtractIndexesHoldingsDAGFactory(BaseDAGFactory):

    def __init__(
        self, configs_path: str, table_name: str, tables_yaml_path: str, default_args: dict
    ):
        self.table_name = table_name
        self.tables_yaml_path = tables_yaml_path
        self.default_args = default_args
        super().__init__(configs_path)

    def create_dag_template(self, dag_id, index, default_args, schedule):
        dag = DAG(
            dag_id=dag_id,
        ...
        with dag:
            ...
            def get_ishares_indexes_task():
                return self.configs[index]["ishares_etf_url"]
...
factory = ExtractIndexesHoldingsDAGFactory(
    indexes_yaml_path, table_name, tables_yaml_path, default_args
)

factory.create_dags()

factory.create_master_dag(master_dag_id="extract_index_holdings_master")
