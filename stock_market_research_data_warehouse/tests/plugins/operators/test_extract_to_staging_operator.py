...
class TestExtractToStagingOperator:
    ...
    def test_execute_success(
        ...
        # Setup mocks
        mock_s3 = MagicMock()
        mock_s3.get_key.return_value.get.return_value = {"Body": MagicMock(read=lambda: b"col1,col2\n1,2\n3,4")}
    ...
    def test_execute_missing_column(
        ...
        mock_s3 = MagicMock()
        mock_s3.get_key.return_value.get.return_value = {"Body": MagicMock(read=lambda: b"col1\n1\n2")}
        mock_s3_hook.return_value = mock_s3
